...
namespace DormitoryManagementSystem.Controllers
{
    ...
    public class SettingsController : Controller
    {
        ...
        public SettingsController(AppDbContext context, AuditService audit)
        {
            _context = context;
            _audit = audit;
        }
        ...
        public IActionResult Backup()
        {
            ...
            var dbPath = Path.Combine(Directory.GetCurrentDirectory(), "dormitory.db");
            ...
            // Read the file and return it as a downloadable response
